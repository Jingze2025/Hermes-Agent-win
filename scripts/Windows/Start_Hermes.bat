...
chcp 65001 >nul 2>&1
:: ============================================================
:: HermesUSB - Start Hermes Agent (CLI Mode)
::
:: Activates the USB venv, isolates all data to USB,
:: and launches Hermes interactive chat.
:: ============================================================
...
:: Ensure tmp and pip_cache dirs exist
...
echo [OK] Home:   %USB_ROOT%\data\home
echo.
...
"%PYTHON_RUNTIME_DIR%\python.exe" -m hermes_cli.main %*

set "EXIT_CODE=!errorlevel!"

echo.
echo ============================================================
echo   Hermes Agent exited with code !EXIT_CODE!
echo ============================================================
pause
