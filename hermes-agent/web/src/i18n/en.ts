...
export const en: Translations = {
  ...
  status: {
    ...
    overview: "Overview",
    overviewSub: "Live snapshot of the agent runtime",
    realtimePulse: "Realtime Pulse",
    health: "Health",
    healthSub: "System composite score",
    activity7d: "Activity (7d)",
    activitySub: "Sessions per day",
    ...
    topModelsEmpty: "No model usage yet",
    ...
    platformsTotal: "platforms",
    online: "online",
    offline: "offline",
    issues: "issues",
    weeklyHeatmap: "Activity Heatmap",
    heatmapHint: "Daily session intensity over the last 12 weeks",
    sessionStream: "Session Stream",
    streamHint: "Live + most recent sessions",
  },
  ...
  analytics: {
    ...
    perDay: "per day",
    modelMix: "Model Mix",
    modelMixEmpty: "No model usage to chart",
    chartArea: "Area",
    chartBar: "Bar",
    avgInput: "avg input",
