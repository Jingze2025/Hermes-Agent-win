...
export const solarDuskTheme: DashboardTheme = {
  name: "solar-dusk",
  label: "Solar Dusk",
  description: "Warm sunset gradient — golden hour oranges and dusky pinks",
  colors: {
    background: "#1a0f0a",
    foreground: "#fef3e2",
    card: "#241610",
    ...
    secondary: "#2a1a12",
    "secondary-foreground": "#fef3e2",
    muted: "#2e1e15",
    "muted-foreground": "#c4956a",
    accent: "#3a2418",
    "accent-foreground": "#fef3e2",
    destructive: "#ef4444",
    "destructive-foreground": "#fff",
    success: "#4ade80",
    warning: "#fbbf24",
    border: "color-mix(in srgb, #f59e0b 18%, transparent)",
    input: "color-mix(in srgb, #f59e0b 18%, transparent)",
    ring: "#f59e0b",
    popover: "#241610",
    "popover-foreground": "#fef3e2",
  },
  overlay: {
    noiseOpacity: 0.07,
    noiseBlendMode: "color-dodge",
    warmGlowOpacity: 0.28,
    warmGlowColor: "rgba(245,158,11,0.35)",
  },
};
